...
<body class=" d-flex flex-column" style="min-height: calc(100vh - 60px);">
    ...
    <div class="container">
        <div class="text-center">
            ...
            <p class="h5 pt-2 pt-md-4">Berikut adalah link untuk masuk ke Grup WhatsApp :</p>
            <a href="{{ url($getPeriodeAktif->group_wa) }}" class="btn btn-success mb-3 mt-4">Gabung ke Grup
                WhatsApp</a>
            <p>Atau klik link berikut <span><a
                        href="{{ $getPeriodeAktif->group_wa }}">{{ $getPeriodeAktif->group_wa }}</a></span></p>
            <br>
