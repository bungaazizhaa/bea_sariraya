            ...
            <div class="text-center col-12 pl-lg-0 col-lg-12 text-lg-left text-center my-auto">
                <center>
                    <div class="pengumuman">
                        ...
                        <a href="{{ url($getPeriodeAktif->group_wa) }}" class="btn btn-success mb-3 mt-2">Gabung ke Grup
                            WhatsApp</a>
                        <p>Atau klik link berikut <span><a href="{{ $getPeriodeAktif->group_wa }}">{{ $getPeriodeAktif->group_wa }}</a></span></p>
                        <br>
                        <p>Jika ada kendala, silahkan hubungi Admin.</p>
                        @auth
                        <a href="{{ url('/my-profile') }}" class="btn btn-outline-light mb-4 mt-2"><i class="fa-solid fa-angle-left"></i>
                            Kembali ke
                            Profil Anda</a>
                        @endauth
                    </div>
