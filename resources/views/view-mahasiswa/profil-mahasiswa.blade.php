...
@if (Route::has('register') && $getTanggalSekarang <= $getPeriodeAktif->ta_adm)
    {{-- MODAL UPLOAD FOTO --}}
    <div class="modal fade" id="editFotoModal" tabindex="-1" role="dialog" aria-labelledby="editFotoModal" aria-hidden="true">
                ...
                <form method="POST" action="{{ route('upload.foto') }}" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="card-body rounded-bottom-md">
                            <img class="img-preview mb-2 d-flex mx-auto" alt="" width="210px" height="280px" style="max-width: 210px; max-height:280px">
                            <div class="input-group mb-3">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="Foto" name="Foto" onchange="previewImage()" value="{{ old('Foto') }}">
            ...
            <div class="modal-content p-3">
                <form method="POST" action="{{ route('update.myuser') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="nim" type="text" class="form-control @error('nim') is-invalid @enderror" name="nim" value="{{ old('nim', Auth::user()->nim) }}" autocomplete="nim" autofocus>
                    ...
                    <div class="row mb-3">
                        <label for="univ_id" class="col-md-4 col-form-label text-md-right">{{ __('Asal Perguruan Tinggi') }}</label>

                        <div class="col-md-6">
                            <select id="univ_id" name="univ_id" class="form-control select" data-live-search="true" onchange="univLainnya(this);">
                                ...
                                <option {{ old('univ_id', Auth::user()->univ_id) == $univ->id ? 'selected' : '' }} value="{{ $univ->id }}">
                    ...
                    <div id="inputuniv" style="display: {{ old('univ_id_manual') == null ? 'none' : 'block' }};">
                        <div class="row mb-3">
                            ...
                            <label for="univ_id_manual" class="col-md-4 col-form-label text-md-right">{{ __('Masukkan Perguruan Tinggi') }}</label>

                            <div class="col-md-6">
                                <input id="univ_id_manual" type="text" class="form-control @error('univ_id_manual') is-invalid @enderror" name="univ_id_manual" value="{{ old('univ_id_manual') }}" autocomplete="univ_id_manual" autofocus>
                    ...
                    <div class="row mb-3">
                        <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('Password Baru (Opsional)') }}</label>

                        <div class="col-md-6">
                            <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" autocomplete="new-password" placeholder="Isi untuk mengubah password.">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="password-confirm" type="password" class="form-control" name="password_confirmation" autocomplete="new-password" placeholder="Tulis kembali password baru.">
                        </div>
                    </div>
