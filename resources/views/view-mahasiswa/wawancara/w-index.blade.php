...
<body>
        ...
        <div class="container d-flex justify-content-between">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto my-2 my-md-0">
                    ...
                    <li class="nav-item mr-0 mr-md-4 pr-md-0 test"><a class="nav-link  pr-3 pr-md-2" href="">Tahap Saat Ini</a>
                    </li>
    ...
    <div class="container">
        <center>
            ...
            <h1 class="text-center mt-3 h2">Halaman Tahap Wawancara (Hanya Melihat Jadwal Kembali)</h1>
