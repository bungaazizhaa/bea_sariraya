...
@section('content')
    ...
    <div class="modal fade" id="tambahPeriode" tabindex="-1" role="dialog"
        aria-labelledby="tambahPeriodeLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <form id="periodeForm" autocomplete="off" method="POST"
                            ...
                            <div class="col-md-4">
                                <div class="bg-secondary p-3 rounded myshadow mb-3">
                                    ...
                                    <input autocomplete="off" id="tm_adm" type="tm_adm"
                                        ...
                                        name="tm_adm" value="{{ old('tm_adm') }}" required
                                        autocomplete="tm_adm" autofocus>
                                    ...
                                    <input autocomplete="off" id="ta_adm" type="ta_adm"
                                        ...
                                        name="ta_adm" value="{{ old('ta_adm') }}" required
                                        autocomplete="ta_adm" autofocus>
                                    ...
                                    <input autocomplete="off" id="tp_adm" type="tp_adm"
                                        ...
                                        name="tp_adm" value="{{ old('tp_adm') }}" required
                                        autocomplete="tp_adm" autofocus>
                            ...
                            <div class="col-md-4">
                                <div class="bg-secondary p-3 rounded myshadow mb-3">
                                    ...
                                    <input autocomplete="off" id="tm_wwn" type="tm_wwn"
                                        ...
                                        name="tm_wwn" value="{{ old('tm_wwn') }}" required
                                        autocomplete="tm_wwn" autofocus>
                                    ...
                                    <input autocomplete="off" id="ta_wwn" type="ta_wwn"
                                        ...
                                        name="ta_wwn" value="{{ old('ta_wwn') }}" required
                                        autocomplete="ta_wwn" autofocus>
                                    ...
                                    <input autocomplete="off" id="tp_wwn" type="tp_wwn"
                                        ...
                                        name="tp_wwn" value="{{ old('tp_wwn') }}" required
                                        autocomplete="tp_wwn" autofocus>
                            ...
                            <div class="col-md-4">
                                <div class="bg-secondary p-3 rounded myshadow mb-3">
                                    ...
                                    <input autocomplete="off" id="tm_png" type="tm_png"
                                        ...
                                        name="tm_png" value="{{ old('tm_png') }}" required
                                        autocomplete="tm_png" autofocus>
                                    ...
                                    <input autocomplete="off" id="ta_png" type="ta_png"
                                        ...
                                        name="ta_png" value="{{ old('ta_png') }}" required
                                        autocomplete="ta_png" autofocus>
                                    ...
                                    <input autocomplete="off" id="tp_png" type="tp_png"
                                        ...
                                        name="tp_png" value="{{ old('tp_png') }}" required
                                        autocomplete="tp_png" autofocus>
