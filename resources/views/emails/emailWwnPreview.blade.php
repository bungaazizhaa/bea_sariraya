...
<head>
    <title>Email {{ $userWwn->name }}</title>
                                                            ...
                                                            <td
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; margin-bottom: 16px;">Dear
                                                                        <strong>{{ $userWwn->name }}</strong><br>Mahasiswa
                                                                        {{ $userWwn->nama_prodi }}<br>di
                                                                        {{ $userWwn->nama_universitas }}.
                                                                    </p>
                                                                    <p style="margin: 0;">Semoga surel ini diterima
                                                                        dalam kondisi baik.<br>Berdasarkan hasil seleksi
                                                                        wawancara, kami menyatakan bahwa Anda :</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">
                                                                        <strong>{{ ucfirst($userWwn->status_wwn) == 'Lolos' ? 'Lolos' : 'Tidak Lolos' }}
                                                                            Tahap
                                                                            Wawancara.</strong>
                                                                    </p>
                                                                </div>
                                                                ...
                                                                <td>
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 0; margin-bottom: 16px;">Kami
                                                                            ...
                                                                            Tahap Penugasan. Berikut adalah soal
                                                                            penugasan
                                                                            Anda.<br><strong>{{ $userWwn->soal }}</strong>
                                                                        </p>
                                                                        <p style="margin: 0;">Persiapkan jawaban tugas
                                                                            Anda dan Submit pada Kolom isian pada Web,
                                                                            saat sesi Tahap Penugasan sudah dimulai.</p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        </table>
