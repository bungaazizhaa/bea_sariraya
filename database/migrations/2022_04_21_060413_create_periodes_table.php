...
class CreatePeriodesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('periodes', function (Blueprint $table) {
            ...
            $table->enum('status_adm', [null, 'Selesai'])->nullable()->comment('Null / Selesai');
            $table->dateTime('ts_adm')->nullable()->comment('TS = Tanggal Set Status');;

            $table->date('tm_wwn');
            $table->date('ta_wwn');
            $table->date('tp_wwn');
            $table->enum('status_wwn', [null, 'Selesai'])->nullable();
            $table->dateTime('ts_wwn')->nullable();

            $table->date('tm_png');
            $table->date('ta_png');
            $table->date('tp_png');
            $table->enum('status_png', [null, 'Selesai'])->nullable();
